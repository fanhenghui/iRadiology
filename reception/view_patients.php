...
//Include Common Files @1-B2BE1649
define("RelativePath", "..");
define("PathToCurrentPage", "/reception/");
define("FileName", "view_patients.php");
...
class clsGridresult { //result class @11-6EB7A6AF
...
//Class_Initialize Event @11-968E1ED6
    function clsGridresult($RelativePath, & $Parent)
    {
        global $FileName;
        global $CCSLocales;
        ...
        $this->date = new clsControl(ccsLabel, "date", "date", ccsDate, array("LongDate"), CCGetRequestParam("date", ccsGet, NULL), $this);
        ...
        $this->more = new clsControl(ccsLink, "more", "more", ccsText, "", CCGetRequestParam("more", ccsGet, NULL), $this);
        $this->more->Page = "patient_info.php";
    }
...
//Show Method @11-1CD8039A
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            $this->ControlsVisible["more"] = $this->more->Visible;
            while ($this->ForceIteration || (($this->RowNumber < $this->PageSize) &&  ($this->HasRecord = $this->DataSource->has_next_record()))) {
                ...
                $this->more->Parameters = CCGetQueryString("QueryString", array("ccsForm"));
                $this->more->Parameters = CCAddParam($this->more->Parameters, "patient_id", $this->DataSource->f("patient_id"));
                $this->more->Parameters = CCAddParam($this->more->Parameters, "result_id", $this->DataSource->f("result_id"));
...
//GetErrors Method @11-0623871D
    function GetErrors()
    {
        ...
        $errors = ComposeStrings($errors, $this->more->Errors->ToString());
...
} //End result Class @11-FCB6E20C

class clsresultDataSource extends clsDBConnection1 {  //resultDataSource Class @11-E277B187

//DataSource Variables @11-05F97868
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @11-29D5B10D
...
//Open Method @11-B90CA9B1
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*)\n\n" .
        "FROM (result LEFT JOIN department ON\n\n" .
        "result.department_id = department.department_id) INNER JOIN status ON\n\n" .
        "result.status_id = status.status_id";
        $this->SQL = "SELECT result.*, department.*, status \n\n" .
        "FROM (result LEFT JOIN department ON\n\n" .
        "result.department_id = department.department_id) INNER JOIN status ON\n\n" .
...
} //End resultDataSource Class @11-FCB6E20C

class clsGridusers_clinic_status_stati { //users_clinic_status_stati class @42-B0F00845

//Variables @42-6E51DF5A
...
//Class_Initialize Event @42-B2ED0336
...
} //End users_clinic_status_stati Class @42-FCB6E20C

class clsusers_clinic_status_statiDataSource extends clsDBConnection1 {  //users_clinic_status_statiDataSource Class @42-CEBFAD73

//DataSource Variables @42-B05D7740
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @42-BF959796
...
} //End users_clinic_status_statiDataSource Class @42-FCB6E20C

//Include Page implementation @179-79776E0A
include_once(RelativePath . "/includes/header_receptionist_vp.php");
//End Include Page implementation

//Initialize Page @1-9FA6F46A
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "view_patients.html";
$BlockToParse = "main";
...
//Include events file @1-F93D490A
include_once("./view_patients_events.php");
...
$result = new clsGridresult("", $MainPage);
$users_clinic_status_stati = new clsGridusers_clinic_status_stati("", $MainPage);
$header_receptionist_vp = new clsheader_receptionist_vp("../includes/", "header_receptionist_vp", $MainPage);
$header_receptionist_vp->Initialize();
...
$MainPage->header_receptionist_vp = & $header_receptionist_vp;
...
//Execute Components @1-9EBEEDB9
$header_receptionist_vp->Operations();
$footer->Operations();
//End Execute Components

//Go to destination page @1-76D94780
if($Redirect)
{
    ...
    $header_receptionist_vp->Class_Terminate();
    unset($header_receptionist_vp);
    unset($Tpl);
    exit;
}
//End Go to destination page

//Show Page @1-C3E50E5A
$footer->Show();
$result->Show();
$users_clinic_status_stati->Show();
$header_receptionist_vp->Show();
$Label1->Show();
$Label2->Show();
$Label3->Show();
$Tpl->block_path = "";
