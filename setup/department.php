...
class clsEditableGriddepartmentdepartment1 { //department1 Class @2-A0358DA0
...
//Class_Initialize Event @2-F738EC2F
    function clsEditableGriddepartmentdepartment1($RelativePath, & $Parent)
    {
        ...
        $this->DataSource = new clsdepartmentdepartment1DataSource($this);
        ...
        $this->department_id = new clsControl(ccsLabel, "department_id", "department_id", ccsInteger, "", NULL, $this);
        $this->department = new clsControl(ccsTextBox, "department", "Department", ccsText, "", NULL, $this);
...
//GetFormParameters Method @2-19FF5E94
    function GetFormParameters()
    {
        for($RowNumber = 1; $RowNumber <= $this->TotalRows; $RowNumber++)
        {
            $this->FormParameters["department"][$RowNumber] = CCGetFromPost("department_" . $RowNumber, NULL);
            $this->FormParameters["CheckBox_Delete"][$RowNumber] = CCGetFromPost("CheckBox_Delete_" . $RowNumber, NULL);
        }
    }
//End GetFormParameters Method

//Validate Method @2-29E1AA9F
    function Validate()
    {
        $Validation = true;
        ...
        for($this->RowNumber = 1; $this->RowNumber <= $this->TotalRows; $this->RowNumber++)
        {
            ...
            $this->department->SetText($this->FormParameters["department"][$this->RowNumber], $this->RowNumber);
...
//CheckInsert Method @2-8CC9436E
    function CheckInsert()
    {
        $filed = false;
        $filed = ($filed || (is_array($this->FormParameters["department"][$this->RowNumber]) && count($this->FormParameters["department"][$this->RowNumber])) || strlen($this->FormParameters["department"][$this->RowNumber]));
        return $filed;
    }
...
//FormScript Method @2-9D002ABD
    function FormScript($TotalRows)
    {
        $script = "";
        $script .= "\n<script language=\"JavaScript\" type=\"text/javascript\">\n<!--\n";
        $script .= "var department1Elements;\n";
        $script .= "var department1EmptyRows = 3;\n";
        $script .= "var " . $this->ComponentName . "departmentID = 0;\n";
        $script .= "var " . $this->ComponentName . "DeleteControl = 1;\n";
        $script .= "\nfunction initdepartment1Elements() {\n";
        $script .= "\tvar ED = document.forms[\"department1\"];\n";
        $script .= "\tdepartment1Elements = new Array (\n";
        for($i = 1; $i <= $TotalRows; $i++) {
            $script .= "\t\tnew Array(" . "ED.department_" . $i . ", " . "ED.CheckBox_Delete_" . $i . ")";
    ...
    function Show()
    {
        ...
        if ($is_next_record || ($EmptyRowsLeft && $this->InsertAllowed)) {
            do {
                ...
                $this->department->Show($this->RowNumber);
...
} //End department1 Class @2-FCB6E20C

class clsdepartmentdepartment1DataSource extends clsDBConnection1 {  //department1DataSource Class @2-572F97AC

//DataSource Variables @2-181B104C
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-8EF1C913
    function clsdepartmentdepartment1DataSource(& $Parent)
    {
        $this->Parent = & $Parent;
        $this->ErrorBlock = "EditableGrid department1/Error";
        $this->Initialize();
...
} //End department1DataSource Class @2-FCB6E20C

class clsdepartment { //department class @1-B8FF548A
...
//Class_Initialize Event @1-A55975B2
    function clsdepartment($RelativePath, $ComponentName, & $Parent)
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        ...
        $this->Visible = true;
        $this->Parent = & $Parent;
        $this->FileName = "department.php";
        $this->Redirect = "";
        $this->TemplateFileName = "department.html";
...
//Class_Terminate Event @1-7E30294C
    function Class_Terminate()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeUnload", $this);
        unset($this->department1);
    }
...
//Operations Method @1-71AE7089
    function Operations()
    {
        global $Redirect;
        if(!$this->Visible)
            return "";
        $this->department1->Operation();
    }
//End Operations Method

//Initialize Method @1-0959D0F7
    function Initialize($Path = "")
    {
        ...
        // Create Components
        $this->department1 = new clsEditableGriddepartmentdepartment1($this->RelativePath, $this);
        $this->department1->Initialize();
        $this->BindEvents();
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "OnInitializeView", $this);
    }
//End Initialize Method

//Show Method @1-BB5D0AA9
    function Show()
    {
        global $Tpl;
        global $CCSLocales;
...
} //End department Class @1-FCB6E20C
?>
