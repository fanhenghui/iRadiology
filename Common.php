...
//Connection Settings @0-D8723A53
...
//Initialize Common Variables @0-22455DE9
...
$CCSDesign = "";
define("CCS_ENCRYPTION_KEY_FOR_COOKIE", 'Vr0505v34Zy4e2I0');
...
function CCSecurityRedirect($GroupsAccess, $URL)
{
    ...
    {
        if(!strlen($URL))
            $Link = RelativePath . "/" . "login/index.php";
        else
            $Link = $URL;
...
//CCCheckAutoLoginCookies @0-B5F1BDA0
...
{
	$db = new clsDBconnection1();
	$sql1 = "select user_status_id from users where user_id=".ccgetuserid();	
	$db->query($sql1);
	$Result1 = $db->next_record(); 
	$ust = $db->f('user_status_id');
	if($Result1)
	return $ust;
}
