...
//Include Common Files @1-35546DA2
define("RelativePath", "..");
define("PathToCurrentPage", "/login/");
define("FileName", "change_pwd.php");
...
//Include Page implementation @10-0CFCC162
include_once(RelativePath . "/setup/change_password.php");
//End Include Page implementation

//Initialize Page @1-2201D952
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "change_pwd.html";
$BlockToParse = "main";
...
$change_password = new clschange_password("../setup/", "change_password", $MainPage);
$change_password->Initialize();
$MainPage->footer = & $footer;
$MainPage->header_changepwd = & $header_changepwd;
$MainPage->change_password = & $change_password;
...
//Execute Components @1-285D07F7
$change_password->Operations();
$header_changepwd->Operations();
$footer->Operations();
//End Execute Components

//Go to destination page @1-AD8F09E4
if($Redirect)
{
    ...
    $change_password->Class_Terminate();
