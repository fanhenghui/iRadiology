...
class clsheader_receptionist_vp { //header_receptionist_vp class @1-535A0B97
...
//Class_Initialize Event @1-39089841
    function clsheader_receptionist_vp($RelativePath, $ComponentName, & $Parent)
    {
        global $CCSLocales;
        ...
        $this->Visible = true;
        $this->Parent = & $Parent;
        $this->FileName = "header_receptionist_vp.php";
        $this->Redirect = "";
        $this->TemplateFileName = "header_receptionist_vp.html";
...
} //End header_receptionist_vp Class @1-FCB6E20C
