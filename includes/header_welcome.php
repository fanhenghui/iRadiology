...
class clsheader_welcome { //header_welcome class @1-DFC3977A
...
//Class_Initialize Event @1-1C6C889C
    function clsheader_welcome($RelativePath, $ComponentName, & $Parent)
    {
        global $CCSLocales;
        ...
        $this->Visible = true;
        $this->Parent = & $Parent;
        $this->FileName = "header_welcome.php";
        $this->Redirect = "";
        $this->TemplateFileName = "header_welcome.html";
...
} //End header_welcome Class @1-FCB6E20C
