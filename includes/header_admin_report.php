...
class clsheader_admin_report { //header_admin_report class @1-932573CC
...
//Class_Initialize Event @1-1199A6EB
    function clsheader_admin_report($RelativePath, $ComponentName, & $Parent)
    {
        global $CCSLocales;
        ...
        $this->Visible = true;
        $this->Parent = & $Parent;
        $this->FileName = "header_admin_report.php";
        $this->Redirect = "";
        $this->TemplateFileName = "header_admin_report.html";
...
} //End header_admin_report Class @1-FCB6E20C
