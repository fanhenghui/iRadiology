...
class clsheader_receptionist_setup { //header_receptionist_setup class @1-752BF4FB
...
//Class_Initialize Event @1-C6041AAD
    function clsheader_receptionist_setup($RelativePath, $ComponentName, & $Parent)
    {
        global $CCSLocales;
        ...
        $this->Visible = true;
        $this->Parent = & $Parent;
        $this->FileName = "header_receptionist_setup.php";
        $this->Redirect = "";
        $this->TemplateFileName = "header_receptionist_setup.html";
...
} //End header_receptionist_setup Class @1-FCB6E20C
