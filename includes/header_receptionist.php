...
class clsheader_receptionist { //header_receptionist class @1-B6222E86
...
//Class_Initialize Event @1-52706A04
    function clsheader_receptionist($RelativePath, $ComponentName, & $Parent)
    {
        global $CCSLocales;
        ...
        $this->Visible = true;
        $this->Parent = & $Parent;
        $this->FileName = "header_receptionist.php";
        $this->Redirect = "";
        $this->TemplateFileName = "header_receptionist.html";
...
} //End header_receptionist Class @1-FCB6E20C
