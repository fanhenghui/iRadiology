...
class clsheader_receptionist_st { //header_receptionist_st class @1-31FD0C78
...
//Class_Initialize Event @1-CBD4B2DC
    function clsheader_receptionist_st($RelativePath, $ComponentName, & $Parent)
    {
        global $CCSLocales;
        ...
        $this->Visible = true;
        $this->Parent = & $Parent;
        $this->FileName = "header_receptionist_st.php";
        $this->Redirect = "";
        $this->TemplateFileName = "header_receptionist_st.html";
...
} //End header_receptionist_st Class @1-FCB6E20C
