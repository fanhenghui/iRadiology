...
class clsheader_admin_setup { //header_admin_setup class @1-D4E03C97
...
//Class_Initialize Event @1-D5A0BFF2
    function clsheader_admin_setup($RelativePath, $ComponentName, & $Parent)
    {
        global $CCSLocales;
        ...
        $this->Visible = true;
        $this->Parent = & $Parent;
        $this->FileName = "header_admin_setup.php";
        $this->Redirect = "";
        $this->TemplateFileName = "header_admin_setup.html";
...
} //End header_admin_setup Class @1-FCB6E20C
