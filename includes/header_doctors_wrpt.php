...
class clsheader_doctors_wrpt { //header_doctors_wrpt class @1-1AF78E08
...
//Class_Initialize Event @1-D8956CFF
    function clsheader_doctors_wrpt($RelativePath, $ComponentName, & $Parent)
    {
        global $CCSLocales;
        ...
        $this->Visible = true;
        $this->Parent = & $Parent;
        $this->FileName = "header_doctors_wrpt.php";
        $this->Redirect = "";
        $this->TemplateFileName = "header_doctors_wrpt.html";
...
} //End header_doctors_wrpt Class @1-FCB6E20C
