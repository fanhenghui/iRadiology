...
class clsheader_doctors { //header_doctors class @1-A1F35621
...
//Class_Initialize Event @1-32103B2B
    function clsheader_doctors($RelativePath, $ComponentName, & $Parent)
    {
        global $CCSLocales;
        ...
        $this->Visible = true;
        $this->Parent = & $Parent;
        $this->FileName = "header_doctors.php";
        $this->Redirect = "";
        $this->TemplateFileName = "header_doctors.html";
...
} //End header_doctors Class @1-FCB6E20C
