...
class clsheader_receptionist_sa { //header_receptionist_sa class @1-0648EA6C
...
//Class_Initialize Event @1-7D2D404F
    function clsheader_receptionist_sa($RelativePath, $ComponentName, & $Parent)
    {
        global $CCSLocales;
        ...
        $this->Visible = true;
        $this->Parent = & $Parent;
        $this->FileName = "header_receptionist_sa.php";
        $this->Redirect = "";
        $this->TemplateFileName = "header_receptionist_sa.html";
...
} //End header_receptionist_sa Class @1-FCB6E20C
