...
class clsheader_changepwd { //header_changepwd class @1-AB027901
...
//Class_Initialize Event @1-F670F601
    function clsheader_changepwd($RelativePath, $ComponentName, & $Parent)
    {
        global $CCSLocales;
        ...
        $this->Visible = true;
        $this->Parent = & $Parent;
        $this->FileName = "header_changepwd.php";
        $this->Redirect = "";
        $this->TemplateFileName = "header_changepwd.html";
...
} //End header_changepwd Class @1-FCB6E20C
