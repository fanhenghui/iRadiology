...
class clsheader_admin { //header_admin class @1-11516FFD
...
//Class_Initialize Event @1-B543365E
    function clsheader_admin($RelativePath, $ComponentName, & $Parent)
    {
        global $CCSLocales;
        ...
        $this->Visible = true;
        $this->Parent = & $Parent;
        $this->FileName = "header_admin.php";
        $this->Redirect = "";
        $this->TemplateFileName = "header_admin.html";
...
} //End header_admin Class @1-FCB6E20C
