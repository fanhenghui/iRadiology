...
class clsheader_outofbound { //header_outofbound class @1-A3C89275
...
//Class_Initialize Event @1-687B9881
    function clsheader_outofbound($RelativePath, $ComponentName, & $Parent)
    {
        global $CCSLocales;
        ...
        $this->Visible = true;
        $this->Parent = & $Parent;
        $this->FileName = "header_outofbound.php";
        $this->Redirect = "";
        $this->TemplateFileName = "header_outofbound.html";
...
} //End header_outofbound Class @1-FCB6E20C
