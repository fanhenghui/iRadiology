...
class clsheader_typist { //header_typist class @1-57704504
...
//Class_Initialize Event @1-4D6E0E6F
    function clsheader_typist($RelativePath, $ComponentName, & $Parent)
    {
        global $CCSLocales;
        ...
        $this->Visible = true;
        $this->Parent = & $Parent;
        $this->FileName = "header_typist.php";
        $this->Redirect = "";
        $this->TemplateFileName = "header_typist.html";
...
} //End header_typist Class @1-FCB6E20C
