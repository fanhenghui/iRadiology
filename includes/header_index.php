...
class clsheader_index { //header_index class @1-DF38F608
...
//Class_Initialize Event @1-EF425D2A
    function clsheader_index($RelativePath, $ComponentName, & $Parent)
    {
        global $CCSLocales;
        ...
        $this->Visible = true;
        $this->Parent = & $Parent;
        $this->FileName = "header_index.php";
        $this->Redirect = "";
        $this->TemplateFileName = "header_index.html";
...
} //End header_index Class @1-FCB6E20C
