...
class clsheader_doctors_setup { //header_doctors_setup class @1-3F1115AA
...
//Class_Initialize Event @1-3BF53763
    function clsheader_doctors_setup($RelativePath, $ComponentName, & $Parent)
    {
        global $CCSLocales;
        ...
        $this->Visible = true;
        $this->Parent = & $Parent;
        $this->FileName = "header_doctors_setup.php";
        $this->Redirect = "";
        $this->TemplateFileName = "header_doctors_setup.html";
...
} //End header_doctors_setup Class @1-FCB6E20C
