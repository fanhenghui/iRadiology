...
class clsheader_access_denied { //header_access_denied class @1-52800153
...
//Class_Initialize Event @1-D7531445
    function clsheader_access_denied($RelativePath, $ComponentName, & $Parent)
    {
        global $CCSLocales;
        ...
        $this->Visible = true;
        $this->Parent = & $Parent;
        $this->FileName = "header_access_denied.php";
        $this->Redirect = "";
        $this->TemplateFileName = "header_access_denied.html";
...
} //End header_access_denied Class @1-FCB6E20C
