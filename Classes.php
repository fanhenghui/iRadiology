...
class clsLocale {
  ...
  function LoadTranslation($filename = "") {
    ...
    $this->Messages["first_name"] = "First Name";
    $this->Messages["last_name"] = "Last Name";
    $this->Messages["middle_name"] = "Middle Name";
    $this->Messages["newrecord1"] = "NewRecord1";
    $this->Messages["textbox1"] = "TextBox1";
    $this->Messages["textbox2"] = "TextBox2";
    $this->Messages["textbox3"] = "TextBox3";
    $this->Messages["user_login"] = "User Login";
    $this->Messages["user_password"] = "User Password";
    $this->Messages["user_status_id"] = "User Status Id";
    $this->Messages["users_recordform"] = "Add/Edit Users ";
    $this->IsLoaded = true;
  }
